...
function crearTablaCorrelaciones() {
  ...
  for (var tr = 0; tr < listadoEventosCorrelacion.length; tr++) {
    // table row creation
    var row = document.createElement("tr"); //accion posicion

    var eventoPulpo = listadoEventosCorrelacion[tr]; //listado de las propiedades
...
},{}],"../../back/Js/index.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Js.c546e476.js.map